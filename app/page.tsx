    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary via-primary/90 to-accent">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                <h1 className="text-2xl font-bold text-white">GoldenHost 🌟</h1>
              </div>
              <div className="hidden md:flex items-center gap-6">
                <button className="text-white/90 hover:text-white transition-colors">Գլխավոր</button>
                <button className="text-white/90 hover:text-white transition-colors">Մեր մասին</button>
                <button className="text-white/90 hover:text-white transition-colors">Ծառայություններ</button>
                <button className="text-white/90 hover:text-white transition-colors">Կապ</button>
                <Button
                  variant="outline"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
              Մենք տրամադրում ենք հուսալի և արագ հոսթինգի ծառայություններ։ Միանա՛ մեզ և վայելե՛ քո կայքի անխափան
              աշխատանքը։
            </p>
            <Button
              size="lg"
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <Card className="bg-white/10 backdrop-blur-lg border-white/20 p-8 text-center hover:bg-white/15 transition-all">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Հուսալիություն</h3>
              <p className="text-white/80">99.9% uptime երաշխիք և անխափան աշխատանք</p>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-lg border-white/20 p-8 text-center hover:bg-white/15 transition-all">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Արագություն</h3>
              <p className="text-white/80">Բարձր արագություն և օպտիմալացված սերվերներ</p>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-lg border-white/20 p-8 text-center hover:bg-white/15 transition-all">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Աջակցություն</h3>
              <p className="text-white/80">24/7 տեխնիկական աջակցություն և օգնություն</p>
            </Card>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 py-6 bg-background/10 backdrop-blur-lg border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-center text-white/70 text-sm">© 2025 GoldenHost — Բոլոր իրավունքները պաշտպանված են。</p>
          </div>
        </div>
      </div>
    )
